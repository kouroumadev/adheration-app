                            ...
                            <tbody>
                                @foreach ($employers as $dem)
                                    <tr>
                                        ...
                                        <td><button  class="btn btn-danger rounded-pill" id="{{ $dem['id'] }}"  data-bs-toggle="modal" data-bs-target="#libererModal{{ $dem['id'] }}" onclick="assignEmpId({{ $dem['id'] }})">Sortie</button></td>
                                    </tr>
