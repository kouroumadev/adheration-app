    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
            <div class="col-md-12 ftco-animate mt-5 pt-md-5" data-scrollax=" properties: { translateY: '70%' }">
                <div class="row">
                    <div class="col-md-">
                        <p class="mb-4 pl-md-5 line" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Votre plateforme digitale pour réaliser vos démarches en ligne en toute simplicité. Si vous n’êtes toujours pas affilié à la CNSS, entamez votre démarche en ligne dès maintenant.</p>
                    </div>
                </div>
                <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">E-CNSS </h1>
                <p><a href="{{route('affiliation') }}" class="btn btn-success px-4 py-3">S'affilier à la CNSS</a></p>
            </div>
        </div>
    </div>
</div>
